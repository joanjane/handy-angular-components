...
gulp.task('rollup:umd', function () {
  return gulp.src(`${buildFolder}/**/*.js`)
    ...
    .pipe(rollup({
      ...
      moduleName: 'handy-angular-components',
    ...
    .pipe(rename('handy-angular-components.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 9. Copy extensions folder
 */
gulp.task('copy:extensions', function () {
  return gulp.src([`${tmpFolder}/extensions/**/*`])
    .pipe(gulp.dest(`${distFolder}/extensions`));
});
...
gulp.task('watch:styles', ['styles'], function () {
  return gulp.watch(sassFiles, ['styles']);
});
